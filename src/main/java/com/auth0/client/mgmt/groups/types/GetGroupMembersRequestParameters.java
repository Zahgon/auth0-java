...
public final class GetGroupMembersRequestParameters {
    ...
    private GetGroupMembersRequestParameters(OptionalNullable<String> fields, OptionalNullable<Boolean> includeFields, OptionalNullable<String> from, OptionalNullable<Integer> take, Map<String, Object> additionalProperties) {
        this.fields = fields;
