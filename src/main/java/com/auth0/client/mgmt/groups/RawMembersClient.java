...
public class RawMembersClient {
     ...
     * List all users that are a member of this group.
     */
    public ManagementApiHttpResponse<SyncPagingIterable<GroupMember>> get(String id, GetGroupMembersRequestParameters request) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     * List all users that are a member of this group.
     */
    public ManagementApiHttpResponse<SyncPagingIterable<GroupMember>> get(String id, GetGroupMembersRequestParameters request, RequestOptions requestOptions) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
}
