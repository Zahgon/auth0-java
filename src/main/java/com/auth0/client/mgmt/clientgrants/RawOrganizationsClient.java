...
public class RawOrganizationsClient {
    ...
    public ManagementApiHttpResponse<SyncPagingIterable<Organization>> list(String id, ListClientGrantOrganizationsRequestParameters request) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }

    public ManagementApiHttpResponse<SyncPagingIterable<Organization>> list(String id, ListClientGrantOrganizationsRequestParameters request, RequestOptions requestOptions) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
}
