...
public final class ListClientGrantOrganizationsRequestParameters {
    ...
    private ListClientGrantOrganizationsRequestParameters(OptionalNullable<String> from, OptionalNullable<Integer> take, Map<String, Object> additionalProperties) {
        this.from = from;
        this.take = take;
