...
public class AsyncRawRulesClient {
     ...
     * Retrieve a filtered list of <a href="https://auth0.com/docs/rules">rules</a>. Accepts a list of fields to include or exclude.
     */
    public CompletableFuture<ManagementApiHttpResponse<SyncPagingIterable<Rule>>> list(ListRulesRequestParameters request) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     * Retrieve a filtered list of <a href="https://auth0.com/docs/rules">rules</a>. Accepts a list of fields to include or exclude.
     */
    public CompletableFuture<ManagementApiHttpResponse<SyncPagingIterable<Rule>>> list(ListRulesRequestParameters request, RequestOptions requestOptions) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     */
    public CompletableFuture<ManagementApiHttpResponse<CreateRuleResponseContent>> create(CreateRuleRequestContent request) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     * <p>Note: Changing a rule's stage of execution from the default <code>login_success</code> can change the rule's function signature to have user omitted.</p>
     */
    public CompletableFuture<ManagementApiHttpResponse<CreateRuleResponseContent>> create(CreateRuleRequestContent request, RequestOptions requestOptions) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     * Retrieve <a href="https://auth0.com/docs/rules">rule</a> details. Accepts a list of fields to include or exclude in the result.
     */
    public CompletableFuture<ManagementApiHttpResponse<GetRuleResponseContent>> get(String id, RequestOptions requestOptions) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     * Retrieve <a href="https://auth0.com/docs/rules">rule</a> details. Accepts a list of fields to include or exclude in the result.
     */
    public CompletableFuture<ManagementApiHttpResponse<GetRuleResponseContent>> get(String id, GetRuleRequestParameters request) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     * Retrieve <a href="https://auth0.com/docs/rules">rule</a> details. Accepts a list of fields to include or exclude in the result.
     */
    public CompletableFuture<ManagementApiHttpResponse<GetRuleResponseContent>> get(String id, GetRuleRequestParameters request, RequestOptions requestOptions) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     * Update an existing rule.
     */
    public CompletableFuture<ManagementApiHttpResponse<UpdateRuleResponseContent>> update(String id, RequestOptions requestOptions) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     * Update an existing rule.
     */
    public CompletableFuture<ManagementApiHttpResponse<UpdateRuleResponseContent>> update(String id, UpdateRuleRequestContent request) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     * Update an existing rule.
     */
    public CompletableFuture<ManagementApiHttpResponse<UpdateRuleResponseContent>> update(String id, UpdateRuleRequestContent request, RequestOptions requestOptions) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
}
