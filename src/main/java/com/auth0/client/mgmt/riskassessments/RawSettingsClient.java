...
public class RawSettingsClient {
     ...
     */
    public ManagementApiHttpResponse<UpdateRiskAssessmentsSettingsResponseContent> update(UpdateRiskAssessmentsSettingsRequestContent request) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     * Updates the tenant settings for risk assessments
     */
    public ManagementApiHttpResponse<UpdateRiskAssessmentsSettingsResponseContent> update(UpdateRiskAssessmentsSettingsRequestContent request, RequestOptions requestOptions) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
}
