...
public final class UpdateGuardianFactorsProviderPushNotificationSnsRequestContent {
    ...
    private UpdateGuardianFactorsProviderPushNotificationSnsRequestContent(OptionalNullable<String> awsAccessKeyId, OptionalNullable<String> awsSecretAccessKey, OptionalNullable<String> awsRegion, OptionalNullable<String> snsApnsPlatformApplicationArn, OptionalNullable<String> snsGcmPlatformApplicationArn, Map<String, Object> additionalProperties) {
