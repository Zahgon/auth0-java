...
public class AsyncRawFactorsClient {
     ...
     */
    public CompletableFuture<ManagementApiHttpResponse<SetGuardianFactorResponseContent>> set(GuardianFactorNameEnum name, SetGuardianFactorRequestContent request) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     * Update the status (i.e., enabled or disabled) of a specific multi-factor authentication factor.
     */
    public CompletableFuture<ManagementApiHttpResponse<SetGuardianFactorResponseContent>> set(GuardianFactorNameEnum name, SetGuardianFactorRequestContent request, RequestOptions requestOptions) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
}
