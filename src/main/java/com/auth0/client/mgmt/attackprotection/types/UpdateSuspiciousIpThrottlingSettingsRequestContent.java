...
public final class UpdateSuspiciousIpThrottlingSettingsRequestContent {
    ...
    private UpdateSuspiciousIpThrottlingSettingsRequestContent(Optional<Boolean> enabled, Optional<List<SuspiciousIpThrottlingShieldsEnum>> shields, Optional<List<String>> allowlist, Optional<SuspiciousIpThrottlingStage> stage, Map<String, Object> additionalProperties) {
