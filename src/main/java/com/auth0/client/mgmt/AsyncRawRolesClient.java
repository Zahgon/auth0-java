...
public class AsyncRawRolesClient {
     ...
     * <p><b>Note</b>: The returned list does not include standard roles available for tenant members, such as Admin or Support Access.</p>
     */
    public CompletableFuture<ManagementApiHttpResponse<SyncPagingIterable<Role>>> list(ListRolesRequestParameters request) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     * <p><b>Note</b>: The returned list does not include standard roles available for tenant members, such as Admin or Support Access.</p>
     */
    public CompletableFuture<ManagementApiHttpResponse<SyncPagingIterable<Role>>> list(ListRolesRequestParameters request, RequestOptions requestOptions) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     */
    public CompletableFuture<ManagementApiHttpResponse<CreateRoleResponseContent>> create(CreateRoleRequestContent request) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     * <p><b>Note</b>: New roles are not associated with any permissions by default. To assign existing permissions to your role, review Associate Permissions with a Role. To create new permissions, review Add API Permissions.</p>
     */
    public CompletableFuture<ManagementApiHttpResponse<CreateRoleResponseContent>> create(CreateRoleRequestContent request, RequestOptions requestOptions) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     * Retrieve details about a specific <a href="https://auth0.com/docs/manage-users/access-control/rbac">user role</a> specified by ID.
     */
    public CompletableFuture<ManagementApiHttpResponse<GetRoleResponseContent>> get(String id, RequestOptions requestOptions) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     * Modify the details of a specific <a href="https://auth0.com/docs/manage-users/access-control/rbac">user role</a> specified by ID.
     */
    public CompletableFuture<ManagementApiHttpResponse<UpdateRoleResponseContent>> update(String id, RequestOptions requestOptions) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     * Modify the details of a specific <a href="https://auth0.com/docs/manage-users/access-control/rbac">user role</a> specified by ID.
     */
    public CompletableFuture<ManagementApiHttpResponse<UpdateRoleResponseContent>> update(String id, UpdateRoleRequestContent request) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     * Modify the details of a specific <a href="https://auth0.com/docs/manage-users/access-control/rbac">user role</a> specified by ID.
     */
    public CompletableFuture<ManagementApiHttpResponse<UpdateRoleResponseContent>> update(String id, UpdateRoleRequestContent request, RequestOptions requestOptions) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
}
