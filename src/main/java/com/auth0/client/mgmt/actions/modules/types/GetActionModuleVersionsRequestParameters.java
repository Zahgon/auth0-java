...
public final class GetActionModuleVersionsRequestParameters {
    ...
    private GetActionModuleVersionsRequestParameters(OptionalNullable<Integer> page, OptionalNullable<Integer> perPage, Map<String, Object> additionalProperties) {
        this.page = page;
