...
public final class CreateOrganizationAllConnectionRequestParameters {
    ...
    private CreateOrganizationAllConnectionRequestParameters(Optional<String> organizationConnectionName, Optional<Boolean> assignMembershipOnLogin, Optional<Boolean> showAsButton, Optional<Boolean> isSignupEnabled, Optional<OrganizationAccessLevelEnum> organizationAccessLevel, Optional<Boolean> isEnabled, String connectionId, Map<String, Object> additionalProperties) {
