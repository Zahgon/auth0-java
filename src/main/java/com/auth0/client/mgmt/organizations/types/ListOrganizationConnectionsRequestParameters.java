...
public final class ListOrganizationConnectionsRequestParameters {
    ...
    private ListOrganizationConnectionsRequestParameters(OptionalNullable<Integer> page, OptionalNullable<Integer> perPage, OptionalNullable<Boolean> includeTotals, Map<String, Object> additionalProperties) {
        this.page = page;
