...
public final class GetOrganizationInvitationRequestParameters {
    ...
    private GetOrganizationInvitationRequestParameters(OptionalNullable<String> fields, OptionalNullable<Boolean> includeFields, Map<String, Object> additionalProperties) {
        this.fields = fields;
