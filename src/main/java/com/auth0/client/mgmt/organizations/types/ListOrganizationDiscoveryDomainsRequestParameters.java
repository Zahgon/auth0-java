...
public final class ListOrganizationDiscoveryDomainsRequestParameters {
    ...
    private ListOrganizationDiscoveryDomainsRequestParameters(OptionalNullable<String> from, OptionalNullable<Integer> take, Map<String, Object> additionalProperties) {
        this.from = from;
        this.take = take;
