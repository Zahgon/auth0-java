...
public final class ListFlowsVaultConnectionsRequestParameters {
    ...
    private ListFlowsVaultConnectionsRequestParameters(OptionalNullable<Integer> page, OptionalNullable<Integer> perPage, OptionalNullable<Boolean> includeTotals, Map<String, Object> additionalProperties) {
        this.page = page;
