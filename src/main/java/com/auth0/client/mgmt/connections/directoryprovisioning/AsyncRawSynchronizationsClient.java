...
public class AsyncRawSynchronizationsClient {
     ...
     */
    public CompletableFuture<ManagementApiHttpResponse<CreateDirectorySynchronizationResponseContent>> create(String id) {
     ...
     * Request an on-demand synchronization of the directory.
     */
    public CompletableFuture<ManagementApiHttpResponse<CreateDirectorySynchronizationResponseContent>> create(String id, RequestOptions requestOptions) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
}
