...
public class AsyncRawUsersClient {
     ...
     */
    public CompletableFuture<ManagementApiHttpResponse<Void>> deleteByEmail(String id, DeleteConnectionUsersByEmailQueryParameters request) {
     ...
     * Deletes a specified connection user by its email (you cannot delete all users from specific connection). Currently, only Database Connections are supported.
     */
    public CompletableFuture<ManagementApiHttpResponse<Void>> deleteByEmail(String id, DeleteConnectionUsersByEmailQueryParameters request, RequestOptions requestOptions) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
}
