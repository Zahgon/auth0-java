...
public final class UpdateConnectionRequestContentYahoo implements IConnectionCommon {
    ...
    private UpdateConnectionRequestContentYahoo(Optional<String> displayName, Optional<List<String>> enabledClients, Optional<Boolean> isDomainConnection, Optional<Map<String, OptionalNullable<String>>> metadata, Optional<ConnectionOptionsYahoo> options, Map<String, Object> additionalProperties) {
