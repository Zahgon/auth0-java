...
public final class CreateConnectionRequestContentDaccount implements ICreateConnectionCommon {
    ...
    private CreateConnectionRequestContentDaccount(String name, Optional<List<String>> enabledClients, Optional<String> displayName, Optional<Boolean> isDomainConnection, Optional<Map<String, OptionalNullable<String>>> metadata, CreateConnectionRequestContentDaccountStrategy strategy, Optional<ConnectionOptionsDaccount> options, Map<String, Object> additionalProperties) {
        this.name = name;
