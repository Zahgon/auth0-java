...
public final class CreateConnectionRequestContentSoundcloud implements ICreateConnectionCommon {
    ...
    private CreateConnectionRequestContentSoundcloud(String name, Optional<List<String>> enabledClients, Optional<String> displayName, Optional<Boolean> isDomainConnection, Optional<Map<String, OptionalNullable<String>>> metadata, CreateConnectionRequestContentSoundcloudStrategy strategy, Optional<ConnectionOptionsSoundcloud> options, Map<String, Object> additionalProperties) {
        this.name = name;
