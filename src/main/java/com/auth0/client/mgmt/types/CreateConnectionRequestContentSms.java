...
public final class CreateConnectionRequestContentSms implements ICreateConnectionCommon {
    ...
    private CreateConnectionRequestContentSms(String name, Optional<List<String>> enabledClients, Optional<String> displayName, Optional<Boolean> isDomainConnection, Optional<Map<String, OptionalNullable<String>>> metadata, CreateConnectionRequestContentSmsStrategy strategy, Optional<ConnectionOptionsSms> options, Map<String, Object> additionalProperties) {
        this.name = name;
