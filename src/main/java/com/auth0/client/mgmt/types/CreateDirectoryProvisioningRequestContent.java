...
public final class CreateDirectoryProvisioningRequestContent {
    ...
    private CreateDirectoryProvisioningRequestContent(Optional<List<DirectoryProvisioningMappingItem>> mapping, Optional<Boolean> synchronizeAutomatically, Optional<SynchronizeGroupsEnum> synchronizeGroups, Map<String, Object> additionalProperties) {
