...
public final class CreateLogStreamEventBridgeRequestBody {
    ...
    private CreateLogStreamEventBridgeRequestBody(Optional<String> name, LogStreamEventBridgeEnum type, Optional<Boolean> isPriority, Optional<List<LogStreamFilter>> filters, Optional<LogStreamPiiConfig> piiConfig, LogStreamEventBridgeSink sink, Optional<String> startFrom, Map<String, Object> additionalProperties) {
        this.name = name;
        this.type = type;
