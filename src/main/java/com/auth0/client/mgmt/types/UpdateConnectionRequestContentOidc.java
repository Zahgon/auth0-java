...
public final class UpdateConnectionRequestContentOidc implements IConnectionCommon {
    ...
    private UpdateConnectionRequestContentOidc(Optional<String> displayName, Optional<List<String>> enabledClients, Optional<Boolean> isDomainConnection, Optional<Map<String, OptionalNullable<String>>> metadata, Optional<ConnectionOptionsOidc> options, Optional<ConnectionAuthenticationPurpose> authentication, Optional<ConnectionConnectedAccountsPurposeXaa> connectedAccounts, Optional<Boolean> showAsButton, Map<String, Object> additionalProperties) {
