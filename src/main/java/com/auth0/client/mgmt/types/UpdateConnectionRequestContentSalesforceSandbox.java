...
public final class UpdateConnectionRequestContentSalesforceSandbox implements IConnectionCommon {
    ...
    private UpdateConnectionRequestContentSalesforceSandbox(Optional<String> displayName, Optional<List<String>> enabledClients, Optional<Boolean> isDomainConnection, Optional<Map<String, OptionalNullable<String>>> metadata, Optional<ConnectionOptionsSalesforce> options, Map<String, Object> additionalProperties) {
