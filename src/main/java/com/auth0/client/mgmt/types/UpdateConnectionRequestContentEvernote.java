...
public final class UpdateConnectionRequestContentEvernote implements IConnectionCommon {
    ...
    private UpdateConnectionRequestContentEvernote(Optional<String> displayName, Optional<List<String>> enabledClients, Optional<Boolean> isDomainConnection, Optional<Map<String, OptionalNullable<String>>> metadata, Optional<ConnectionOptionsEvernote> options, Map<String, Object> additionalProperties) {
