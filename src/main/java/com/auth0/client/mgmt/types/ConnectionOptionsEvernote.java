...
public final class ConnectionOptionsEvernote implements IConnectionOptionsOAuth1Common, IConnectionOptionsCommon {
    ...
    private ConnectionOptionsEvernote(Optional<String> clientId, Optional<String> clientSecret, Optional<ConnectionSetUserRootAttributesEnum> setUserRootAttributes, OptionalNullable<Map<String, OptionalNullable<ConnectionUpstreamAdditionalProperties>>> upstreamParams, Optional<List<String>> nonPersistentAttrs, Map<String, Object> additionalProperties) {
    ...
    private boolean equalTo(ConnectionOptionsEvernote other) {
        return clientId.equals(other.clientId) && clientSecret.equals(other.clientSecret) && setUserRootAttributes.equals(other.setUserRootAttributes) && upstreamParams.equals(other.upstreamParams) && nonPersistentAttrs.equals(other.nonPersistentAttrs);
    }
