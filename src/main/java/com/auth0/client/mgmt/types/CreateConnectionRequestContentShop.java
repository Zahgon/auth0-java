...
public final class CreateConnectionRequestContentShop implements ICreateConnectionCommon {
    ...
    private CreateConnectionRequestContentShop(String name, Optional<List<String>> enabledClients, Optional<String> displayName, Optional<Boolean> isDomainConnection, Optional<Map<String, OptionalNullable<String>>> metadata, CreateConnectionRequestContentShopStrategy strategy, Optional<ConnectionOptionsShop> options, Map<String, Object> additionalProperties) {
        this.name = name;
