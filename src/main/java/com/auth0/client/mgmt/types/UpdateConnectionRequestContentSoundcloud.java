...
public final class UpdateConnectionRequestContentSoundcloud implements IConnectionCommon {
    ...
    private UpdateConnectionRequestContentSoundcloud(Optional<String> displayName, Optional<List<String>> enabledClients, Optional<Boolean> isDomainConnection, Optional<Map<String, OptionalNullable<String>>> metadata, Optional<ConnectionOptionsSoundcloud> options, Map<String, Object> additionalProperties) {
