...
public final class GetGuardianFactorDuoSettingsResponseContent {
    ...
    private GetGuardianFactorDuoSettingsResponseContent(Optional<String> ikey, Optional<String> skey, Optional<String> host, Map<String, Object> additionalProperties) {
        this.ikey = ikey;
        this.skey = skey;
        this.host = host;
