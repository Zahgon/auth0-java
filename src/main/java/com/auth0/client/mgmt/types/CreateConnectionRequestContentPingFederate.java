...
public final class CreateConnectionRequestContentPingFederate implements ICreateConnectionCommon {
    ...
    private CreateConnectionRequestContentPingFederate(String name, Optional<List<String>> enabledClients, Optional<String> displayName, Optional<Boolean> isDomainConnection, Optional<Map<String, OptionalNullable<String>>> metadata, CreateConnectionRequestContentPingFederateStrategy strategy, Optional<ConnectionOptionsPingFederate> options, Optional<Boolean> showAsButton, Map<String, Object> additionalProperties) {
        this.name = name;
