...
public final class UserAttributeProfile {
    ...
    private UserAttributeProfile(Optional<String> id, Optional<String> name, Optional<UserAttributeProfileUserId> userId, Optional<Map<String, UserAttributeProfileUserAttributeAdditionalProperties>> userAttributes, Map<String, Object> additionalProperties) {
        this.id = id;
        this.name = name;
        this.userId = userId;
