...
public final class RollbackActionModuleResponseContent {
    ...
    private RollbackActionModuleResponseContent(Optional<String> id, Optional<String> name, Optional<String> code, Optional<List<ActionModuleDependency>> dependencies, Optional<List<ActionModuleSecret>> secrets, Optional<Integer> actionsUsingModuleTotal, Optional<Boolean> allChangesPublished, Optional<Integer> latestVersionNumber, Optional<OffsetDateTime> createdAt, Optional<OffsetDateTime> updatedAt, Optional<ActionModuleVersionReference> latestVersion, Map<String, Object> additionalProperties) {
        this.id = id;
        this.name = name;
        this.code = code;
