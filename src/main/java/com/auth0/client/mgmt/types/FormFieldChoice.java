...
public final class FormFieldChoice {
    ...
    private FormFieldChoice(String id, FormComponentCategoryFieldConst category, FormFieldTypeChoiceConst type, Optional<FormFieldChoiceConfig> config, Optional<String> label, Optional<String> hint, Optional<Boolean> required, Optional<Boolean> sensitive, Map<String, Object> additionalProperties) {
        this.id = id;
