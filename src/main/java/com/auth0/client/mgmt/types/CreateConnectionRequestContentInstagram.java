...
public final class CreateConnectionRequestContentInstagram implements ICreateConnectionCommon {
    ...
    private CreateConnectionRequestContentInstagram(String name, Optional<List<String>> enabledClients, Optional<String> displayName, Optional<Boolean> isDomainConnection, Optional<Map<String, OptionalNullable<String>>> metadata, CreateConnectionRequestContentInstagramStrategy strategy, Optional<ConnectionOptionsInstagram> options, Map<String, Object> additionalProperties) {
        this.name = name;
