...
public final class UpdateConnectionRequestContentLine implements IConnectionCommon {
    ...
    private UpdateConnectionRequestContentLine(Optional<String> displayName, Optional<List<String>> enabledClients, Optional<Boolean> isDomainConnection, Optional<Map<String, OptionalNullable<String>>> metadata, Optional<ConnectionOptionsLine> options, Map<String, Object> additionalProperties) {
