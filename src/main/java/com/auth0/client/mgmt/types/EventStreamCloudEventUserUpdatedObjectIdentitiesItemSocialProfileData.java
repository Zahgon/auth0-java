...
public final class EventStreamCloudEventUserUpdatedObjectIdentitiesItemSocialProfileData {
    ...
    private EventStreamCloudEventUserUpdatedObjectIdentitiesItemSocialProfileData(Optional<String> email, Optional<Boolean> emailVerified, Optional<String> name, Optional<String> username, Optional<String> givenName, Optional<String> familyName, Optional<String> phoneNumber, Optional<Boolean> phoneVerified, Map<String, Object> additionalProperties) {
        this.email = email;
