...
public final class UpdateConnectionRequestContentCustom implements IConnectionCommon {
    ...
    private UpdateConnectionRequestContentCustom(Optional<String> displayName, Optional<List<String>> enabledClients, Optional<Boolean> isDomainConnection, Optional<Map<String, OptionalNullable<String>>> metadata, Optional<Map<String, Object>> options, Map<String, Object> additionalProperties) {
