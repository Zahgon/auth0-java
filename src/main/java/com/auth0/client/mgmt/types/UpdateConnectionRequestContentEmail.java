...
public final class UpdateConnectionRequestContentEmail implements IConnectionCommon {
    ...
    private UpdateConnectionRequestContentEmail(Optional<String> displayName, Optional<List<String>> enabledClients, Optional<Boolean> isDomainConnection, Optional<Map<String, OptionalNullable<String>>> metadata, Optional<ConnectionOptionsEmail> options, Map<String, Object> additionalProperties) {
