...
public final class CreateConnectionRequestContentBaidu implements ICreateConnectionCommon {
    ...
    private CreateConnectionRequestContentBaidu(String name, Optional<List<String>> enabledClients, Optional<String> displayName, Optional<Boolean> isDomainConnection, Optional<Map<String, OptionalNullable<String>>> metadata, CreateConnectionRequestContentBaiduStrategy strategy, Optional<ConnectionOptionsBaidu> options, Map<String, Object> additionalProperties) {
        this.name = name;
