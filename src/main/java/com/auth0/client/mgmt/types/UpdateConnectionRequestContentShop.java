...
public final class UpdateConnectionRequestContentShop implements IConnectionCommon {
    ...
    private UpdateConnectionRequestContentShop(Optional<String> displayName, Optional<List<String>> enabledClients, Optional<Boolean> isDomainConnection, Optional<Map<String, OptionalNullable<String>>> metadata, Optional<ConnectionOptionsShop> options, Map<String, Object> additionalProperties) {
