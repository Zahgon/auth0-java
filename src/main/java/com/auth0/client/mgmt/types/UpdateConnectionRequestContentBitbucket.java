...
public final class UpdateConnectionRequestContentBitbucket implements IConnectionCommon {
    ...
    private UpdateConnectionRequestContentBitbucket(Optional<String> displayName, Optional<List<String>> enabledClients, Optional<Boolean> isDomainConnection, Optional<Map<String, OptionalNullable<String>>> metadata, Optional<ConnectionOptionsBitbucket> options, Map<String, Object> additionalProperties) {
