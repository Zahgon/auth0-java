...
public final class UpdateConnectionRequestContentOffice365 implements IConnectionCommon {
    ...
    private UpdateConnectionRequestContentOffice365(Optional<String> displayName, Optional<List<String>> enabledClients, Optional<Boolean> isDomainConnection, Optional<Map<String, OptionalNullable<String>>> metadata, Optional<ConnectionOptionsOffice365> options, Optional<Boolean> showAsButton, Map<String, Object> additionalProperties) {
