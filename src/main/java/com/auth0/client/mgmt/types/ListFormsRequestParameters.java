...
public final class ListFormsRequestParameters {
    ...
    private ListFormsRequestParameters(Optional<List<FormsRequestParametersHydrateEnum>> hydrate, OptionalNullable<Integer> page, OptionalNullable<Integer> perPage, OptionalNullable<Boolean> includeTotals, Map<String, Object> additionalProperties) {
