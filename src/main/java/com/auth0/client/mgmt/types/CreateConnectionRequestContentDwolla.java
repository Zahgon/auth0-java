...
public final class CreateConnectionRequestContentDwolla implements ICreateConnectionCommon {
    ...
    private CreateConnectionRequestContentDwolla(String name, Optional<List<String>> enabledClients, Optional<String> displayName, Optional<Boolean> isDomainConnection, Optional<Map<String, OptionalNullable<String>>> metadata, CreateConnectionRequestContentDwollaStrategy strategy, Optional<ConnectionOptionsDwolla> options, Map<String, Object> additionalProperties) {
        this.name = name;
