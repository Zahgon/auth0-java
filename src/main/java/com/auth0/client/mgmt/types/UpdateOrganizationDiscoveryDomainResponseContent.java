...
public final class UpdateOrganizationDiscoveryDomainResponseContent {
    ...
    private UpdateOrganizationDiscoveryDomainResponseContent(String id, String domain, OrganizationDiscoveryDomainStatus status, Optional<Boolean> useForOrganizationDiscovery, String verificationTxt, String verificationHost, Map<String, Object> additionalProperties) {
        this.id = id;
        this.domain = domain;
        this.status = status;
