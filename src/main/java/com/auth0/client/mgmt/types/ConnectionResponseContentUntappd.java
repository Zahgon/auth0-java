...
public final class ConnectionResponseContentUntappd implements IConnectionPurposes, IConnectionResponseCommon, ICreateConnectionCommon {
    ...
    private ConnectionResponseContentUntappd(Optional<ConnectionAuthenticationPurpose> authentication, Optional<ConnectionConnectedAccountsPurpose> connectedAccounts, String id, Optional<List<String>> realms, String name, Optional<List<String>> enabledClients, Optional<String> displayName, Optional<Boolean> isDomainConnection, Optional<Map<String, OptionalNullable<String>>> metadata, ConnectionResponseContentUntappdStrategy strategy, Optional<ConnectionOptionsUntappd> options, Map<String, Object> additionalProperties) {
