...
public final class UpdateConnectionRequestContentSms implements IConnectionCommon {
    ...
    private UpdateConnectionRequestContentSms(Optional<String> displayName, Optional<List<String>> enabledClients, Optional<Boolean> isDomainConnection, Optional<Map<String, OptionalNullable<String>>> metadata, Optional<ConnectionOptionsSms> options, Map<String, Object> additionalProperties) {
