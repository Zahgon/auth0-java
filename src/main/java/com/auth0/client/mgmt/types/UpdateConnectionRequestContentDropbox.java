...
public final class UpdateConnectionRequestContentDropbox implements IConnectionCommon {
    ...
    private UpdateConnectionRequestContentDropbox(Optional<String> displayName, Optional<List<String>> enabledClients, Optional<Boolean> isDomainConnection, Optional<Map<String, OptionalNullable<String>>> metadata, Optional<ConnectionOptionsDropbox> options, Map<String, Object> additionalProperties) {
