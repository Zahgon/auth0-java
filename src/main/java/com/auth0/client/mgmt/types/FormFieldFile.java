...
public final class FormFieldFile {
    ...
    private FormFieldFile(String id, FormComponentCategoryFieldConst category, FormFieldTypeFileConst type, Optional<FormFieldFileConfig> config, Optional<String> label, Optional<String> hint, Optional<Boolean> required, Optional<Boolean> sensitive, Map<String, Object> additionalProperties) {
        this.id = id;
