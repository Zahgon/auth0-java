...
public final class CreateConnectionRequestContentCustom implements ICreateConnectionCommon {
    ...
    private CreateConnectionRequestContentCustom(String name, Optional<List<String>> enabledClients, Optional<String> displayName, Optional<Boolean> isDomainConnection, Optional<Map<String, OptionalNullable<String>>> metadata, CreateConnectionRequestContentCustomStrategy strategy, Optional<Map<String, Object>> options, Map<String, Object> additionalProperties) {
        this.name = name;
