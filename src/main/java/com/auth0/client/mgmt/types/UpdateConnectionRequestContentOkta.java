...
public final class UpdateConnectionRequestContentOkta implements IConnectionCommon {
    ...
    private UpdateConnectionRequestContentOkta(Optional<String> displayName, Optional<List<String>> enabledClients, Optional<Boolean> isDomainConnection, Optional<Map<String, OptionalNullable<String>>> metadata, Optional<ConnectionOptionsOkta> options, Optional<Boolean> showAsButton, Map<String, Object> additionalProperties) {
