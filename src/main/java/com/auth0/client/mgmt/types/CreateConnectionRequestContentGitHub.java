...
public final class CreateConnectionRequestContentGitHub implements IConnectionPurposes, ICreateConnectionCommon {
    ...
    private CreateConnectionRequestContentGitHub(Optional<ConnectionAuthenticationPurpose> authentication, Optional<ConnectionConnectedAccountsPurpose> connectedAccounts, String name, Optional<List<String>> enabledClients, Optional<String> displayName, Optional<Boolean> isDomainConnection, Optional<Map<String, OptionalNullable<String>>> metadata, CreateConnectionRequestContentGitHubStrategy strategy, Optional<ConnectionOptionsGitHub> options, Map<String, Object> additionalProperties) {
