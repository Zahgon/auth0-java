...
public final class UpdateConnectionRequestContentPaypal implements IConnectionCommon {
    ...
    private UpdateConnectionRequestContentPaypal(Optional<String> displayName, Optional<List<String>> enabledClients, Optional<Boolean> isDomainConnection, Optional<Map<String, OptionalNullable<String>>> metadata, Optional<ConnectionOptionsPaypal> options, Map<String, Object> additionalProperties) {
