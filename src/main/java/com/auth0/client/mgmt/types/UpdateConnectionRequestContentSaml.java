...
public final class UpdateConnectionRequestContentSaml implements IConnectionCommon {
    ...
    private UpdateConnectionRequestContentSaml(Optional<String> displayName, Optional<List<String>> enabledClients, Optional<Boolean> isDomainConnection, Optional<Map<String, OptionalNullable<String>>> metadata, Optional<ConnectionOptionsSaml> options, Optional<Boolean> showAsButton, Map<String, Object> additionalProperties) {
