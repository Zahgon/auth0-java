...
public final class ConnectionResponseContentGitHub implements IConnectionPurposes, IConnectionResponseCommon, ICreateConnectionCommon {
    ...
    private ConnectionResponseContentGitHub(Optional<ConnectionAuthenticationPurpose> authentication, Optional<ConnectionConnectedAccountsPurpose> connectedAccounts, String id, Optional<List<String>> realms, String name, Optional<List<String>> enabledClients, Optional<String> displayName, Optional<Boolean> isDomainConnection, Optional<Map<String, OptionalNullable<String>>> metadata, ConnectionResponseContentGitHubStrategy strategy, Optional<ConnectionOptionsGitHub> options, Map<String, Object> additionalProperties) {
