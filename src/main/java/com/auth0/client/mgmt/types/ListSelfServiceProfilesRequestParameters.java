...
public final class ListSelfServiceProfilesRequestParameters {
    ...
    private ListSelfServiceProfilesRequestParameters(OptionalNullable<Integer> page, OptionalNullable<Integer> perPage, OptionalNullable<Boolean> includeTotals, Map<String, Object> additionalProperties) {
        this.page = page;
