...
public final class ConnectionResponseContentEvernoteSandbox implements IConnectionPurposes, IConnectionResponseCommon, ICreateConnectionCommon {
    ...
    private ConnectionResponseContentEvernoteSandbox(Optional<ConnectionAuthenticationPurpose> authentication, Optional<ConnectionConnectedAccountsPurpose> connectedAccounts, String id, Optional<List<String>> realms, String name, Optional<List<String>> enabledClients, Optional<String> displayName, Optional<Boolean> isDomainConnection, Optional<Map<String, OptionalNullable<String>>> metadata, ConnectionResponseContentEvernoteSandboxStrategy strategy, Optional<ConnectionOptionsEvernote> options, Map<String, Object> additionalProperties) {
