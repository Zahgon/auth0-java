...
public final class UpdateConnectionRequestContentShopify implements IConnectionCommon {
    ...
    private UpdateConnectionRequestContentShopify(Optional<String> displayName, Optional<List<String>> enabledClients, Optional<Boolean> isDomainConnection, Optional<Map<String, OptionalNullable<String>>> metadata, Optional<ConnectionOptionsShopify> options, Map<String, Object> additionalProperties) {
