...
public final class CreateLogStreamHttpRequestBody {
    ...
    private CreateLogStreamHttpRequestBody(Optional<String> name, LogStreamHttpEnum type, Optional<Boolean> isPriority, Optional<List<LogStreamFilter>> filters, Optional<LogStreamPiiConfig> piiConfig, LogStreamHttpSink sink, Optional<String> startFrom, Map<String, Object> additionalProperties) {
        this.name = name;
        this.type = type;
