...
public final class UpdateConnectionRequestContentEvernoteSandbox implements IConnectionCommon {
    ...
    private UpdateConnectionRequestContentEvernoteSandbox(Optional<String> displayName, Optional<List<String>> enabledClients, Optional<Boolean> isDomainConnection, Optional<Map<String, OptionalNullable<String>>> metadata, Optional<ConnectionOptionsEvernote> options, Map<String, Object> additionalProperties) {
