...
public final class CreateConnectionRequestContentOAuth2 implements IConnectionPurposes, ICreateConnectionCommon {
    ...
    private CreateConnectionRequestContentOAuth2(Optional<ConnectionAuthenticationPurpose> authentication, Optional<ConnectionConnectedAccountsPurpose> connectedAccounts, String name, Optional<List<String>> enabledClients, Optional<String> displayName, Optional<Boolean> isDomainConnection, Optional<Map<String, OptionalNullable<String>>> metadata, CreateConnectionRequestContentOAuth2Strategy strategy, Optional<ConnectionOptionsOAuth2> options, Map<String, Object> additionalProperties) {
