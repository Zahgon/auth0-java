...
public final class FormFieldPassword {
    ...
    private FormFieldPassword(String id, FormComponentCategoryFieldConst category, FormFieldTypePasswordConst type, FormFieldPasswordConfig config, Optional<String> label, Optional<String> hint, Optional<Boolean> required, Optional<Boolean> sensitive, Map<String, Object> additionalProperties) {
        this.id = id;
