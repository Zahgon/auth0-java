...
public final class FormFieldEmail {
    ...
    private FormFieldEmail(String id, FormComponentCategoryFieldConst category, FormFieldTypeEmailConst type, Optional<FormFieldEmailConfig> config, Optional<String> label, Optional<String> hint, Optional<Boolean> required, Optional<Boolean> sensitive, Map<String, Object> additionalProperties) {
        this.id = id;
