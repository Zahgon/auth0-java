...
public final class CreateConnectionRequestContentExact implements ICreateConnectionCommon {
    ...
    private CreateConnectionRequestContentExact(String name, Optional<List<String>> enabledClients, Optional<String> displayName, Optional<Boolean> isDomainConnection, Optional<Map<String, OptionalNullable<String>>> metadata, CreateConnectionRequestContentExactStrategy strategy, Optional<ConnectionOptionsExact> options, Map<String, Object> additionalProperties) {
        this.name = name;
