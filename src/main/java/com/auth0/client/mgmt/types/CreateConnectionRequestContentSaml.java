...
public final class CreateConnectionRequestContentSaml implements ICreateConnectionCommon {
    ...
    private CreateConnectionRequestContentSaml(String name, Optional<List<String>> enabledClients, Optional<String> displayName, Optional<Boolean> isDomainConnection, Optional<Map<String, OptionalNullable<String>>> metadata, CreateConnectionRequestContentSamlStrategy strategy, Optional<ConnectionOptionsSaml> options, Optional<Boolean> showAsButton, Map<String, Object> additionalProperties) {
        this.name = name;
