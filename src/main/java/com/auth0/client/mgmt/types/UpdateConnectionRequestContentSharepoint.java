...
public final class UpdateConnectionRequestContentSharepoint implements IConnectionCommon {
    ...
    private UpdateConnectionRequestContentSharepoint(Optional<String> displayName, Optional<List<String>> enabledClients, Optional<Boolean> isDomainConnection, Optional<Map<String, OptionalNullable<String>>> metadata, Optional<ConnectionOptionsSharepoint> options, Optional<Boolean> showAsButton, Map<String, Object> additionalProperties) {
