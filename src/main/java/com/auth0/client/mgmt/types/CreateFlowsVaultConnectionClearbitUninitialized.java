...
public final class CreateFlowsVaultConnectionClearbitUninitialized {
    ...
    private CreateFlowsVaultConnectionClearbitUninitialized(String name, FlowsVaultConnectionAppIdClearbitEnum appId, Map<String, Object> additionalProperties) {
        this.name = name;
        this.appId = appId;
