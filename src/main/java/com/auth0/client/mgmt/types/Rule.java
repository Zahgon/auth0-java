...
public final class Rule {
    ...
    private Rule(Optional<String> name, Optional<String> id, Optional<Boolean> enabled, Optional<String> script, Optional<Double> order, Optional<String> stage, Map<String, Object> additionalProperties) {
        this.name = name;
        this.id = id;
