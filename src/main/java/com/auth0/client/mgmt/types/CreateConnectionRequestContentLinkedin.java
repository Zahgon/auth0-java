...
public final class CreateConnectionRequestContentLinkedin implements ICreateConnectionCommon {
    ...
    private CreateConnectionRequestContentLinkedin(String name, Optional<List<String>> enabledClients, Optional<String> displayName, Optional<Boolean> isDomainConnection, Optional<Map<String, OptionalNullable<String>>> metadata, CreateConnectionRequestContentLinkedinStrategy strategy, Optional<ConnectionOptionsLinkedin> options, Map<String, Object> additionalProperties) {
        this.name = name;
