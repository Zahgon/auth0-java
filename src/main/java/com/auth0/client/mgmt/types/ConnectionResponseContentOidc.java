...
public final class ConnectionResponseContentOidc implements IConnectionResponseCommon, ICreateConnectionCommon {
    ...
    private ConnectionResponseContentOidc(String id, Optional<List<String>> realms, String name, Optional<List<String>> enabledClients, Optional<String> displayName, Optional<Boolean> isDomainConnection, Optional<Map<String, OptionalNullable<String>>> metadata, ConnectionResponseContentOidcStrategy strategy, Optional<ConnectionAuthenticationPurpose> authentication, Optional<ConnectionConnectedAccountsPurposeXaa> connectedAccounts, Optional<ConnectionOptionsOidc> options, Optional<Boolean> showAsButton, Map<String, Object> additionalProperties) {
        this.id = id;
        this.realms = realms;
        this.name = name;
