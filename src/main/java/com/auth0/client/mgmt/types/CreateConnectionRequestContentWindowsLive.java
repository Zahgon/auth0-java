...
public final class CreateConnectionRequestContentWindowsLive implements IConnectionPurposes, ICreateConnectionCommon {
    ...
    private CreateConnectionRequestContentWindowsLive(Optional<ConnectionAuthenticationPurpose> authentication, Optional<ConnectionConnectedAccountsPurpose> connectedAccounts, String name, Optional<List<String>> enabledClients, Optional<String> displayName, Optional<Boolean> isDomainConnection, Optional<Map<String, OptionalNullable<String>>> metadata, CreateConnectionRequestContentWindowsLiveStrategy strategy, Optional<ConnectionOptionsWindowsLive> options, Map<String, Object> additionalProperties) {
