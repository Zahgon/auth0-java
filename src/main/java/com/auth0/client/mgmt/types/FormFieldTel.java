...
public final class FormFieldTel {
    ...
    private FormFieldTel(String id, FormComponentCategoryFieldConst category, FormFieldTypeTelConst type, Optional<FormFieldTelConfig> config, Optional<String> label, Optional<String> hint, Optional<Boolean> required, Optional<Boolean> sensitive, Map<String, Object> additionalProperties) {
        this.id = id;
