...
public final class LogStreamHttpResponseSchema {
    ...
    private LogStreamHttpResponseSchema(Optional<String> id, Optional<String> name, Optional<LogStreamStatusEnum> status, Optional<LogStreamHttpEnum> type, Optional<Boolean> isPriority, Optional<List<LogStreamFilter>> filters, Optional<LogStreamPiiConfig> piiConfig, Optional<LogStreamHttpSink> sink, Map<String, Object> additionalProperties) {
        this.id = id;
        this.name = name;
        this.status = status;
        this.type = type;
