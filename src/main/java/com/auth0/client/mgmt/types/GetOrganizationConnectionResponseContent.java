...
public final class GetOrganizationConnectionResponseContent {
    ...
    private GetOrganizationConnectionResponseContent(Optional<String> connectionId, Optional<Boolean> assignMembershipOnLogin, Optional<Boolean> showAsButton, Optional<Boolean> isSignupEnabled, Optional<OrganizationConnectionInformation> connection, Map<String, Object> additionalProperties) {
