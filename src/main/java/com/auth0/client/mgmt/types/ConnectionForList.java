...
public final class ConnectionForList {
    ...
    private ConnectionForList(Optional<String> name, Optional<String> displayName, Optional<Map<String, Object>> options, Optional<String> id, Optional<String> strategy, Optional<List<String>> realms, Optional<Boolean> isDomainConnection, Optional<Boolean> showAsButton, Optional<Map<String, OptionalNullable<String>>> metadata, Optional<ConnectionAuthenticationPurpose> authentication, Optional<ConnectionConnectedAccountsPurpose> connectedAccounts, Map<String, Object> additionalProperties) {
        this.name = name;
