...
public final class UpdateConnectionRequestContentWindowsLive implements IConnectionCommon, IConnectionPurposes {
    ...
    private UpdateConnectionRequestContentWindowsLive(Optional<String> displayName, Optional<List<String>> enabledClients, Optional<Boolean> isDomainConnection, Optional<Map<String, OptionalNullable<String>>> metadata, Optional<ConnectionAuthenticationPurpose> authentication, Optional<ConnectionConnectedAccountsPurpose> connectedAccounts, Optional<ConnectionOptionsWindowsLive> options, Map<String, Object> additionalProperties) {
