...
public final class CreateConnectionRequestContentAuth0Oidc implements ICreateConnectionCommon {
    ...
    private CreateConnectionRequestContentAuth0Oidc(String name, Optional<List<String>> enabledClients, Optional<String> displayName, Optional<Boolean> isDomainConnection, Optional<Map<String, OptionalNullable<String>>> metadata, CreateConnectionRequestContentAuth0OidcStrategy strategy, Optional<ConnectionOptionsAuth0Oidc> options, Map<String, Object> additionalProperties) {
        this.name = name;
