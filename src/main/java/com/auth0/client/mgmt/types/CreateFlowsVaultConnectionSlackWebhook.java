...
public final class CreateFlowsVaultConnectionSlackWebhook {
    ...
    private CreateFlowsVaultConnectionSlackWebhook(String name, FlowsVaultConnectionAppIdSlackEnum appId, FlowsVaultConnectioSetupWebhook setup, Map<String, Object> additionalProperties) {
        this.name = name;
        this.appId = appId;
        this.setup = setup;
