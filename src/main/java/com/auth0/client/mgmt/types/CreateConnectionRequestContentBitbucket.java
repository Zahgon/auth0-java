...
public final class CreateConnectionRequestContentBitbucket implements ICreateConnectionCommon {
    ...
    private CreateConnectionRequestContentBitbucket(String name, Optional<List<String>> enabledClients, Optional<String> displayName, Optional<Boolean> isDomainConnection, Optional<Map<String, OptionalNullable<String>>> metadata, CreateConnectionRequestContentBitbucketStrategy strategy, Optional<ConnectionOptionsBitbucket> options, Map<String, Object> additionalProperties) {
        this.name = name;
