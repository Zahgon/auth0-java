...
public final class UpdateConnectionRequestContentIp implements IConnectionCommon {
    ...
    private UpdateConnectionRequestContentIp(Optional<String> displayName, Optional<List<String>> enabledClients, Optional<Boolean> isDomainConnection, Optional<Map<String, OptionalNullable<String>>> metadata, Optional<Map<String, Object>> options, Optional<Boolean> showAsButton, Map<String, Object> additionalProperties) {
