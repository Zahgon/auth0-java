...
public final class ListResourceServerRequestParameters {
    ...
    private ListResourceServerRequestParameters(Optional<List<String>> identifiers, OptionalNullable<Integer> page, OptionalNullable<Integer> perPage, OptionalNullable<Boolean> includeTotals, OptionalNullable<Boolean> includeFields, Map<String, Object> additionalProperties) {
    ...
    private boolean equalTo(ListResourceServerRequestParameters other) {
        return identifiers.equals(other.identifiers) && page.equals(other.page) && perPage.equals(other.perPage) && includeTotals.equals(other.includeTotals) && includeFields.equals(other.includeFields);
    }
