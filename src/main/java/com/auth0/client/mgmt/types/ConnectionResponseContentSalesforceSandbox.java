...
public final class ConnectionResponseContentSalesforceSandbox implements IConnectionPurposes, IConnectionResponseCommon, ICreateConnectionCommon {
    ...
    private ConnectionResponseContentSalesforceSandbox(Optional<ConnectionAuthenticationPurpose> authentication, Optional<ConnectionConnectedAccountsPurpose> connectedAccounts, String id, Optional<List<String>> realms, String name, Optional<List<String>> enabledClients, Optional<String> displayName, Optional<Boolean> isDomainConnection, Optional<Map<String, OptionalNullable<String>>> metadata, ConnectionResponseContentSalesforceSandboxStrategy strategy, Optional<ConnectionOptionsSalesforce> options, Map<String, Object> additionalProperties) {
