...
public final class FormFieldBoolean {
    ...
    private FormFieldBoolean(String id, FormComponentCategoryFieldConst category, FormFieldTypeBooleanConst type, FormFieldBooleanConfig config, Optional<String> label, Optional<String> hint, Optional<Boolean> required, Optional<Boolean> sensitive, Map<String, Object> additionalProperties) {
        this.id = id;
