...
public final class CreateConnectionRequestContentSalesforceCommunity implements ICreateConnectionCommon {
    ...
    private CreateConnectionRequestContentSalesforceCommunity(String name, Optional<List<String>> enabledClients, Optional<String> displayName, Optional<Boolean> isDomainConnection, Optional<Map<String, OptionalNullable<String>>> metadata, CreateConnectionRequestContentSalesforceCommunityStrategy strategy, Optional<ConnectionOptionsSalesforceCommunity> options, Map<String, Object> additionalProperties) {
        this.name = name;
