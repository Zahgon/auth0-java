...
public final class CreateConnectionRequestContentWeibo implements ICreateConnectionCommon {
    ...
    private CreateConnectionRequestContentWeibo(String name, Optional<List<String>> enabledClients, Optional<String> displayName, Optional<Boolean> isDomainConnection, Optional<Map<String, OptionalNullable<String>>> metadata, CreateConnectionRequestContentWeiboStrategy strategy, Optional<ConnectionOptionsWeibo> options, Map<String, Object> additionalProperties) {
        this.name = name;
