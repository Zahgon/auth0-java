...
public final class CreateLogStreamDatadogRequestBody {
    ...
    private CreateLogStreamDatadogRequestBody(Optional<String> name, LogStreamDatadogEnum type, Optional<Boolean> isPriority, Optional<List<LogStreamFilter>> filters, Optional<LogStreamPiiConfig> piiConfig, LogStreamDatadogSink sink, Optional<String> startFrom, Map<String, Object> additionalProperties) {
        this.name = name;
        this.type = type;
