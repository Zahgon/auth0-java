...
public final class CreateConnectionRequestContentPlanningCenter implements ICreateConnectionCommon {
    ...
    private CreateConnectionRequestContentPlanningCenter(String name, Optional<List<String>> enabledClients, Optional<String> displayName, Optional<Boolean> isDomainConnection, Optional<Map<String, OptionalNullable<String>>> metadata, CreateConnectionRequestContentPlanningCenterStrategy strategy, Optional<ConnectionOptionsPlanningCenter> options, Map<String, Object> additionalProperties) {
        this.name = name;
