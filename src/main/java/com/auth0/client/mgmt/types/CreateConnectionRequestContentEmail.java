...
public final class CreateConnectionRequestContentEmail implements ICreateConnectionCommon {
    ...
    private CreateConnectionRequestContentEmail(String name, Optional<List<String>> enabledClients, Optional<String> displayName, Optional<Boolean> isDomainConnection, Optional<Map<String, OptionalNullable<String>>> metadata, CreateConnectionRequestContentEmailStrategy strategy, Optional<ConnectionOptionsEmail> options, Map<String, Object> additionalProperties) {
        this.name = name;
