...
public final class CreateConnectionRequestContentPaypal implements ICreateConnectionCommon {
    ...
    private CreateConnectionRequestContentPaypal(String name, Optional<List<String>> enabledClients, Optional<String> displayName, Optional<Boolean> isDomainConnection, Optional<Map<String, OptionalNullable<String>>> metadata, CreateConnectionRequestContentPaypalStrategy strategy, Optional<ConnectionOptionsPaypal> options, Map<String, Object> additionalProperties) {
        this.name = name;
