...
public final class ConnectionResponseContentOffice365 implements IConnectionPurposes, IConnectionResponseCommon, ICreateConnectionCommon {
    ...
    private ConnectionResponseContentOffice365(Optional<ConnectionAuthenticationPurpose> authentication, Optional<ConnectionConnectedAccountsPurpose> connectedAccounts, String id, Optional<List<String>> realms, String name, Optional<List<String>> enabledClients, Optional<String> displayName, Optional<Boolean> isDomainConnection, Optional<Map<String, OptionalNullable<String>>> metadata, ConnectionResponseContentOffice365Strategy strategy, Optional<ConnectionOptionsOffice365> options, Optional<String> provisioningTicketUrl, Optional<Boolean> showAsButton, Map<String, Object> additionalProperties) {
