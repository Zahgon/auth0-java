...
public final class CreateFlowsVaultConnectionZapierWebhook {
    ...
    private CreateFlowsVaultConnectionZapierWebhook(String name, FlowsVaultConnectionAppIdZapierEnum appId, FlowsVaultConnectioSetupWebhook setup, Map<String, Object> additionalProperties) {
        this.name = name;
        this.appId = appId;
        this.setup = setup;
