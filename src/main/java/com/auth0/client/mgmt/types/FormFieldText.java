...
public final class FormFieldText {
    ...
    private FormFieldText(String id, FormComponentCategoryFieldConst category, FormFieldTypeTextConst type, Optional<FormFieldTextConfig> config, Optional<String> label, Optional<String> hint, Optional<Boolean> required, Optional<Boolean> sensitive, Map<String, Object> additionalProperties) {
        this.id = id;
