...
public final class UpdateFlowResponseContent {
    ...
    private UpdateFlowResponseContent(String id, String name, Optional<List<FlowAction>> actions, OffsetDateTime createdAt, OffsetDateTime updatedAt, Optional<String> executedAt, Map<String, Object> additionalProperties) {
        this.id = id;
        this.name = name;
