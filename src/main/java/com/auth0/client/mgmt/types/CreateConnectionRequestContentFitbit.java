...
public final class CreateConnectionRequestContentFitbit implements ICreateConnectionCommon {
    ...
    private CreateConnectionRequestContentFitbit(String name, Optional<List<String>> enabledClients, Optional<String> displayName, Optional<Boolean> isDomainConnection, Optional<Map<String, OptionalNullable<String>>> metadata, CreateConnectionRequestContentFitbitStrategy strategy, Optional<ConnectionOptionsFitbit> options, Map<String, Object> additionalProperties) {
        this.name = name;
