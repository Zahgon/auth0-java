...
public final class UpdateConnectionRequestContentAdfs implements IConnectionCommon {
    ...
    private UpdateConnectionRequestContentAdfs(Optional<String> displayName, Optional<List<String>> enabledClients, Optional<Boolean> isDomainConnection, Optional<Map<String, OptionalNullable<String>>> metadata, Optional<ConnectionOptionsAdfs> options, Optional<Boolean> showAsButton, Map<String, Object> additionalProperties) {
