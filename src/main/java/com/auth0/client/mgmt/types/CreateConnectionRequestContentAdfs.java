...
public final class CreateConnectionRequestContentAdfs implements ICreateConnectionCommon {
    ...
    private CreateConnectionRequestContentAdfs(String name, Optional<List<String>> enabledClients, Optional<String> displayName, Optional<Boolean> isDomainConnection, Optional<Map<String, OptionalNullable<String>>> metadata, CreateConnectionRequestContentAdfsStrategy strategy, Optional<ConnectionOptionsAdfs> options, Optional<Boolean> showAsButton, Map<String, Object> additionalProperties) {
        this.name = name;
