...
public final class FormWidgetGMapsAddress {
    ...
    private FormWidgetGMapsAddress(String id, FormComponentCategoryWidgetConst category, FormWidgetTypeGMapsAddressConst type, FormWidgetGMapsAddressConfig config, Optional<String> label, Optional<String> hint, Optional<Boolean> required, Optional<Boolean> sensitive, Map<String, Object> additionalProperties) {
        this.id = id;
