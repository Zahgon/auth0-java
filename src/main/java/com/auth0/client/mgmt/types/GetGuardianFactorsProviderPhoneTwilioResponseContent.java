...
public final class GetGuardianFactorsProviderPhoneTwilioResponseContent {
    ...
    private GetGuardianFactorsProviderPhoneTwilioResponseContent(OptionalNullable<String> from, OptionalNullable<String> messagingServiceSid, OptionalNullable<String> authToken, OptionalNullable<String> sid, Map<String, Object> additionalProperties) {
        this.from = from;
