...
public final class CreateConnectionRequestContentOAuth1 implements ICreateConnectionCommon {
    ...
    private CreateConnectionRequestContentOAuth1(String name, Optional<List<String>> enabledClients, Optional<String> displayName, Optional<Boolean> isDomainConnection, Optional<Map<String, OptionalNullable<String>>> metadata, CreateConnectionRequestContentOAuth1Strategy strategy, Optional<ConnectionOptionsOAuth1> options, Map<String, Object> additionalProperties) {
        this.name = name;
