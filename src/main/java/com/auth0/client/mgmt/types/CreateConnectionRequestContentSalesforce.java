...
public final class CreateConnectionRequestContentSalesforce implements ICreateConnectionCommon {
    ...
    private CreateConnectionRequestContentSalesforce(String name, Optional<List<String>> enabledClients, Optional<String> displayName, Optional<Boolean> isDomainConnection, Optional<Map<String, OptionalNullable<String>>> metadata, CreateConnectionRequestContentSalesforceStrategy strategy, Optional<ConnectionOptionsSalesforce> options, Map<String, Object> additionalProperties) {
        this.name = name;
