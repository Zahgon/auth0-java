...
public final class CreateFlowResponseContent {
    ...
    private CreateFlowResponseContent(String id, String name, Optional<List<FlowAction>> actions, OffsetDateTime createdAt, OffsetDateTime updatedAt, Optional<String> executedAt, Map<String, Object> additionalProperties) {
        this.id = id;
        this.name = name;
