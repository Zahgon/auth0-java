...
public final class UpdateConnectionRequestContentOAuth2 implements IConnectionCommon, IConnectionPurposes {
    ...
    private UpdateConnectionRequestContentOAuth2(Optional<String> displayName, Optional<List<String>> enabledClients, Optional<Boolean> isDomainConnection, Optional<Map<String, OptionalNullable<String>>> metadata, Optional<ConnectionAuthenticationPurpose> authentication, Optional<ConnectionConnectedAccountsPurpose> connectedAccounts, Optional<ConnectionOptionsOAuth2> options, Map<String, Object> additionalProperties) {
