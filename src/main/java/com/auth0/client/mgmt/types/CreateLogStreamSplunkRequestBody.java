...
public final class CreateLogStreamSplunkRequestBody {
    ...
    private CreateLogStreamSplunkRequestBody(Optional<String> name, LogStreamSplunkEnum type, Optional<Boolean> isPriority, Optional<List<LogStreamFilter>> filters, Optional<LogStreamPiiConfig> piiConfig, LogStreamSplunkSink sink, Optional<String> startFrom, Map<String, Object> additionalProperties) {
        this.name = name;
        this.type = type;
