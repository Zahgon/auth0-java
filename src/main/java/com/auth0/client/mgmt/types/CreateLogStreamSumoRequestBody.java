...
public final class CreateLogStreamSumoRequestBody {
    ...
    private CreateLogStreamSumoRequestBody(Optional<String> name, LogStreamSumoEnum type, Optional<Boolean> isPriority, Optional<List<LogStreamFilter>> filters, Optional<LogStreamPiiConfig> piiConfig, LogStreamSumoSink sink, Optional<String> startFrom, Map<String, Object> additionalProperties) {
        this.name = name;
        this.type = type;
