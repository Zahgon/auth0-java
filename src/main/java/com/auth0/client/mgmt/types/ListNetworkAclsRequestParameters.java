...
public final class ListNetworkAclsRequestParameters {
    ...
    private ListNetworkAclsRequestParameters(OptionalNullable<Integer> page, OptionalNullable<Integer> perPage, OptionalNullable<Boolean> includeTotals, Map<String, Object> additionalProperties) {
        this.page = page;
