...
public final class ListLogOffsetPaginatedResponseContent {
    ...
    private ListLogOffsetPaginatedResponseContent(Optional<Double> start, Optional<Double> limit, Optional<Double> length, Optional<Double> total, Optional<List<Log>> logs, Map<String, Object> additionalProperties) {
        this.start = start;
        this.limit = limit;
        this.length = length;
        this.total = total;
