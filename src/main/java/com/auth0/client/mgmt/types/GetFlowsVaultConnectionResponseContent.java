...
public final class GetFlowsVaultConnectionResponseContent {
    ...
    private GetFlowsVaultConnectionResponseContent(String id, String appId, Optional<String> environment, String name, Optional<String> accountName, boolean ready, OffsetDateTime createdAt, OffsetDateTime updatedAt, Optional<OffsetDateTime> refreshedAt, String fingerprint, Map<String, Object> additionalProperties) {
        this.id = id;
        this.appId = appId;
