...
public final class CreateConnectionRequestContentFacebook implements ICreateConnectionCommon {
    ...
    private CreateConnectionRequestContentFacebook(String name, Optional<List<String>> enabledClients, Optional<String> displayName, Optional<Boolean> isDomainConnection, Optional<Map<String, OptionalNullable<String>>> metadata, CreateConnectionRequestContentFacebookStrategy strategy, Optional<ConnectionOptionsFacebook> options, Map<String, Object> additionalProperties) {
        this.name = name;
