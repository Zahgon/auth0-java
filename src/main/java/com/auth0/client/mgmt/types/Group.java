...
public final class Group implements IGroup {
    ...
    private Group(Optional<String> id, Optional<String> name, Optional<String> externalId, Optional<String> connectionId, Optional<String> tenantName, Optional<OffsetDateTime> createdAt, Optional<OffsetDateTime> updatedAt, Map<String, Object> additionalProperties) {
        this.id = id;
        this.name = name;
