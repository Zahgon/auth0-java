...
public final class UpdateBruteForceSettingsResponseContent {
    ...
    private UpdateBruteForceSettingsResponseContent(Optional<Boolean> enabled, Optional<List<BruteForceProtectionShieldsEnum>> shields, Optional<List<String>> allowlist, Optional<BruteForceProtectionModeEnum> mode, Optional<Integer> maxAttempts, Map<String, Object> additionalProperties) {
