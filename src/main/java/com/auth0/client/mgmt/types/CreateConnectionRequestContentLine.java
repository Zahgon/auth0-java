...
public final class CreateConnectionRequestContentLine implements ICreateConnectionCommon {
    ...
    private CreateConnectionRequestContentLine(String name, Optional<List<String>> enabledClients, Optional<String> displayName, Optional<Boolean> isDomainConnection, Optional<Map<String, OptionalNullable<String>>> metadata, CreateConnectionRequestContentLineStrategy strategy, Optional<ConnectionOptionsLine> options, Map<String, Object> additionalProperties) {
        this.name = name;
