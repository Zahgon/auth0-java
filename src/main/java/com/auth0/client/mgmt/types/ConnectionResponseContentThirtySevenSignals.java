...
public final class ConnectionResponseContentThirtySevenSignals implements IConnectionPurposes, IConnectionResponseCommon, ICreateConnectionCommon {
    ...
    private ConnectionResponseContentThirtySevenSignals(Optional<ConnectionAuthenticationPurpose> authentication, Optional<ConnectionConnectedAccountsPurpose> connectedAccounts, String id, Optional<List<String>> realms, String name, Optional<List<String>> enabledClients, Optional<String> displayName, Optional<Boolean> isDomainConnection, Optional<Map<String, OptionalNullable<String>>> metadata, ConnectionResponseContentThirtySevenSignalsStrategy strategy, Optional<ConnectionOptionsThirtySevenSignals> options, Map<String, Object> additionalProperties) {
