...
public final class OrganizationEnabledConnection {
    ...
    private OrganizationEnabledConnection(Optional<String> connectionId, Optional<Boolean> assignMembershipOnLogin, Optional<Boolean> showAsButton, Optional<Boolean> isSignupEnabled, Optional<OrganizationConnectionInformation> connection, Map<String, Object> additionalProperties) {
