...
public final class FormFieldLegal {
    ...
    private FormFieldLegal(String id, FormComponentCategoryFieldConst category, FormFieldTypeLegalConst type, Optional<FormFieldLegalConfig> config, Optional<String> label, Optional<String> hint, Optional<Boolean> required, Optional<Boolean> sensitive, Map<String, Object> additionalProperties) {
        this.id = id;
