...
public final class FormWidgetRecaptcha {
    ...
    private FormWidgetRecaptcha(String id, FormComponentCategoryWidgetConst category, FormWidgetTypeRecaptchaConst type, FormWidgetRecaptchaConfig config, Optional<String> label, Optional<String> hint, Optional<Boolean> required, Optional<Boolean> sensitive, Map<String, Object> additionalProperties) {
        this.id = id;
