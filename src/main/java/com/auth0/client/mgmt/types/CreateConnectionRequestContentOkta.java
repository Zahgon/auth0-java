...
public final class CreateConnectionRequestContentOkta implements ICreateConnectionCommon {
    ...
    private CreateConnectionRequestContentOkta(String name, Optional<List<String>> enabledClients, Optional<String> displayName, Optional<Boolean> isDomainConnection, Optional<Map<String, OptionalNullable<String>>> metadata, CreateConnectionRequestContentOktaStrategy strategy, Optional<ConnectionOptionsOkta> options, Optional<Boolean> showAsButton, Map<String, Object> additionalProperties) {
        this.name = name;
