...
public final class ConnectionCommon implements IConnectionCommon {
    ...
    private ConnectionCommon(Optional<String> displayName, Optional<List<String>> enabledClients, Optional<Boolean> isDomainConnection, Optional<Map<String, OptionalNullable<String>>> metadata, Map<String, Object> additionalProperties) {
    ...
    private boolean equalTo(ConnectionCommon other) {
        return displayName.equals(other.displayName) && enabledClients.equals(other.enabledClients) && isDomainConnection.equals(other.isDomainConnection) && metadata.equals(other.metadata);
    }
