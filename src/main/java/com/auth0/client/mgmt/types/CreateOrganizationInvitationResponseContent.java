...
public final class CreateOrganizationInvitationResponseContent {
    ...
    private CreateOrganizationInvitationResponseContent(Optional<String> id, Optional<String> organizationId, Optional<OrganizationInvitationInviter> inviter, Optional<OrganizationInvitationInvitee> invitee, Optional<String> invitationUrl, Optional<OffsetDateTime> createdAt, Optional<OffsetDateTime> expiresAt, Optional<String> clientId, Optional<String> connectionId, Optional<Map<String, Object>> appMetadata, Optional<Map<String, Object>> userMetadata, Optional<List<String>> roles, Optional<String> ticketId, Map<String, Object> additionalProperties) {
        this.id = id;
