...
public final class CreateEventStreamActionRequestContent {
    ...
    private CreateEventStreamActionRequestContent(Optional<String> name, Optional<List<EventStreamSubscription>> subscriptions, EventStreamActionDestination destination, Optional<EventStreamStatusEnum> status, Map<String, Object> additionalProperties) {
        this.name = name;
