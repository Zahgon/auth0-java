...
public final class CreateConnectionRequestContentUntappd implements ICreateConnectionCommon {
    ...
    private CreateConnectionRequestContentUntappd(String name, Optional<List<String>> enabledClients, Optional<String> displayName, Optional<Boolean> isDomainConnection, Optional<Map<String, OptionalNullable<String>>> metadata, CreateConnectionRequestContentUntappdStrategy strategy, Optional<ConnectionOptionsUntappd> options, Map<String, Object> additionalProperties) {
        this.name = name;
