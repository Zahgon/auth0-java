...
public final class FormFieldCustom {
    ...
    private FormFieldCustom(String id, FormComponentCategoryFieldConst category, FormFieldTypeCustomConst type, FormFieldCustomConfig config, Optional<String> label, Optional<String> hint, Optional<Boolean> required, Optional<Boolean> sensitive, Map<String, Object> additionalProperties) {
        this.id = id;
