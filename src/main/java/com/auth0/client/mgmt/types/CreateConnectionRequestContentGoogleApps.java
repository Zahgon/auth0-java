...
public final class CreateConnectionRequestContentGoogleApps implements ICreateConnectionCommon {
    ...
    private CreateConnectionRequestContentGoogleApps(String name, Optional<List<String>> enabledClients, Optional<String> displayName, Optional<Boolean> isDomainConnection, Optional<Map<String, OptionalNullable<String>>> metadata, CreateConnectionRequestContentGoogleAppsStrategy strategy, Optional<ConnectionOptionsGoogleApps> options, Optional<Boolean> showAsButton, Map<String, Object> additionalProperties) {
        this.name = name;
