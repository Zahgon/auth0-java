...
public final class CreateConnectionRequestContentTwitter implements ICreateConnectionCommon {
    ...
    private CreateConnectionRequestContentTwitter(String name, Optional<List<String>> enabledClients, Optional<String> displayName, Optional<Boolean> isDomainConnection, Optional<Map<String, OptionalNullable<String>>> metadata, CreateConnectionRequestContentTwitterStrategy strategy, Optional<ConnectionOptionsTwitter> options, Map<String, Object> additionalProperties) {
        this.name = name;
