...
public final class CreateConnectionRequestContentApple implements ICreateConnectionCommon {
    ...
    private CreateConnectionRequestContentApple(String name, Optional<List<String>> enabledClients, Optional<String> displayName, Optional<Boolean> isDomainConnection, Optional<Map<String, OptionalNullable<String>>> metadata, CreateConnectionRequestContentAppleStrategy strategy, Optional<ConnectionOptionsApple> options, Map<String, Object> additionalProperties) {
        this.name = name;
