...
public final class SetEmailTemplateRequestContent {
    ...
    private SetEmailTemplateRequestContent(EmailTemplateNameEnum template, OptionalNullable<String> body, OptionalNullable<String> from, OptionalNullable<String> resultUrl, OptionalNullable<String> subject, OptionalNullable<String> syntax, OptionalNullable<Double> urlLifetimeInSeconds, Optional<Boolean> includeEmailInRedirect, OptionalNullable<Boolean> enabled, Map<String, Object> additionalProperties) {
