...
public final class CreateConnectionRequestContentSalesforceSandbox implements ICreateConnectionCommon {
    ...
    private CreateConnectionRequestContentSalesforceSandbox(String name, Optional<List<String>> enabledClients, Optional<String> displayName, Optional<Boolean> isDomainConnection, Optional<Map<String, OptionalNullable<String>>> metadata, CreateConnectionRequestContentSalesforceSandboxStrategy strategy, Optional<ConnectionOptionsSalesforce> options, Map<String, Object> additionalProperties) {
        this.name = name;
