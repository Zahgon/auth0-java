...
public final class FlowActionAuth0CreateUser {
    ...
    private FlowActionAuth0CreateUser(String id, Optional<String> alias, FlowActionAuth0CreateUserType type, FlowActionAuth0CreateUserAction action, Optional<Boolean> allowFailure, Optional<Boolean> maskOutput, FlowActionAuth0CreateUserParams params, Map<String, Object> additionalProperties) {
        this.id = id;
        this.alias = alias;
        this.type = type;
        this.action = action;
