...
public final class CreateConnectionRequestContentPaypalSandbox implements ICreateConnectionCommon {
    ...
    private CreateConnectionRequestContentPaypalSandbox(String name, Optional<List<String>> enabledClients, Optional<String> displayName, Optional<Boolean> isDomainConnection, Optional<Map<String, OptionalNullable<String>>> metadata, CreateConnectionRequestContentPaypalSandboxStrategy strategy, Optional<ConnectionOptionsPaypal> options, Map<String, Object> additionalProperties) {
        this.name = name;
