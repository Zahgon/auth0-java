...
public final class CreateConnectionRequestContentWordpress implements ICreateConnectionCommon {
    ...
    private CreateConnectionRequestContentWordpress(String name, Optional<List<String>> enabledClients, Optional<String> displayName, Optional<Boolean> isDomainConnection, Optional<Map<String, OptionalNullable<String>>> metadata, CreateConnectionRequestContentWordpressStrategy strategy, Optional<ConnectionOptionsWordpress> options, Map<String, Object> additionalProperties) {
        this.name = name;
