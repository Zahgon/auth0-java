...
public final class UpdateConnectionRequestContentAd implements IConnectionCommon {
    ...
    private UpdateConnectionRequestContentAd(Optional<String> displayName, Optional<List<String>> enabledClients, Optional<Boolean> isDomainConnection, Optional<Map<String, OptionalNullable<String>>> metadata, Optional<ConnectionOptionsAd> options, Map<String, Object> additionalProperties) {
