...
public final class UpdateSettingsResponseContent {
    ...
    private UpdateSettingsResponseContent(Optional<UniversalLoginExperienceEnum> universalLoginExperience, Optional<Boolean> identifierFirst, Optional<Boolean> webauthnPlatformFirstFactor, Map<String, Object> additionalProperties) {
