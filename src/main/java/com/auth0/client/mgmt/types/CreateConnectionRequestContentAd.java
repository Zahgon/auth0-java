...
public final class CreateConnectionRequestContentAd implements ICreateConnectionCommon {
    ...
    private CreateConnectionRequestContentAd(String name, Optional<List<String>> enabledClients, Optional<String> displayName, Optional<Boolean> isDomainConnection, Optional<Map<String, OptionalNullable<String>>> metadata, CreateConnectionRequestContentAdStrategy strategy, Optional<ConnectionOptionsAd> options, Map<String, Object> additionalProperties) {
        this.name = name;
