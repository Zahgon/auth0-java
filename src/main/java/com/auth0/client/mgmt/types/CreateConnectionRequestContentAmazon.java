...
public final class CreateConnectionRequestContentAmazon implements ICreateConnectionCommon {
    ...
    private CreateConnectionRequestContentAmazon(String name, Optional<List<String>> enabledClients, Optional<String> displayName, Optional<Boolean> isDomainConnection, Optional<Map<String, OptionalNullable<String>>> metadata, CreateConnectionRequestContentAmazonStrategy strategy, Optional<ConnectionOptionsAmazon> options, Map<String, Object> additionalProperties) {
        this.name = name;
