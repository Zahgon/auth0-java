...
public final class PatchClientCredentialResponseContent {
    ...
    private PatchClientCredentialResponseContent(Optional<String> id, Optional<String> name, Optional<String> kid, Optional<ClientCredentialAlgorithmEnum> alg, Optional<ClientCredentialTypeEnum> credentialType, Optional<String> subjectDn, Optional<String> thumbprintSha256, Optional<OffsetDateTime> createdAt, Optional<OffsetDateTime> updatedAt, Optional<OffsetDateTime> expiresAt, Map<String, Object> additionalProperties) {
        this.id = id;
        this.name = name;
        this.kid = kid;
        this.alg = alg;
