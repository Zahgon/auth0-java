...
public final class FormFieldCards {
    ...
    private FormFieldCards(String id, FormComponentCategoryFieldConst category, FormFieldTypeCardsConst type, Optional<FormFieldCardsConfig> config, Optional<String> label, Optional<String> hint, Optional<Boolean> required, Optional<Boolean> sensitive, Map<String, Object> additionalProperties) {
        this.id = id;
