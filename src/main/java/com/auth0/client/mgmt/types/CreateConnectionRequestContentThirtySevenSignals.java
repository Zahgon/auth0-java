...
public final class CreateConnectionRequestContentThirtySevenSignals implements ICreateConnectionCommon {
    ...
    private CreateConnectionRequestContentThirtySevenSignals(String name, Optional<List<String>> enabledClients, Optional<String> displayName, Optional<Boolean> isDomainConnection, Optional<Map<String, OptionalNullable<String>>> metadata, CreateConnectionRequestContentThirtySevenSignalsStrategy strategy, Optional<ConnectionOptionsThirtySevenSignals> options, Map<String, Object> additionalProperties) {
        this.name = name;
