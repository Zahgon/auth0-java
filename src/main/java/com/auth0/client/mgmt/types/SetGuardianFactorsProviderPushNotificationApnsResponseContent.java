...
public final class SetGuardianFactorsProviderPushNotificationApnsResponseContent {
    ...
    private SetGuardianFactorsProviderPushNotificationApnsResponseContent(Optional<Boolean> sandbox, OptionalNullable<String> bundleId, Map<String, Object> additionalProperties) {
