...
public final class CreateConnectionRequestContentBitly implements ICreateConnectionCommon {
    ...
    private CreateConnectionRequestContentBitly(String name, Optional<List<String>> enabledClients, Optional<String> displayName, Optional<Boolean> isDomainConnection, Optional<Map<String, OptionalNullable<String>>> metadata, CreateConnectionRequestContentBitlyStrategy strategy, Optional<ConnectionOptionsBitly> options, Map<String, Object> additionalProperties) {
        this.name = name;
