...
public final class UpdateHookResponseContent {
    ...
    private UpdateHookResponseContent(Optional<String> triggerId, Optional<String> id, Optional<String> name, Optional<Boolean> enabled, Optional<String> script, Optional<Map<String, String>> dependencies, Map<String, Object> additionalProperties) {
