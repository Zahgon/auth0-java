...
public final class FlowActionActivecampaignListContacts {
    ...
    private FlowActionActivecampaignListContacts(String id, Optional<String> alias, FlowActionActivecampaignListContactsType type, FlowActionActivecampaignListContactsAction action, Optional<Boolean> allowFailure, Optional<Boolean> maskOutput, FlowActionActivecampaignListContactsParams params, Map<String, Object> additionalProperties) {
        this.id = id;
        this.alias = alias;
        this.type = type;
        this.action = action;
