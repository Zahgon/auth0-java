...
public final class ListUserRolesOffsetPaginatedResponseContent {
    ...
    private ListUserRolesOffsetPaginatedResponseContent(Optional<Double> start, Optional<Double> limit, Optional<Double> total, Optional<List<Role>> roles, Map<String, Object> additionalProperties) {
        this.start = start;
        this.limit = limit;
        this.total = total;
        this.roles = roles;
