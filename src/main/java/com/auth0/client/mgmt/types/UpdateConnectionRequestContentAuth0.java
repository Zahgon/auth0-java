...
public final class UpdateConnectionRequestContentAuth0 implements IConnectionCommon {
    ...
    private UpdateConnectionRequestContentAuth0(Optional<String> displayName, Optional<List<String>> enabledClients, Optional<Boolean> isDomainConnection, Optional<Map<String, OptionalNullable<String>>> metadata, Optional<ConnectionOptionsAuth0> options, Optional<List<String>> realms, Map<String, Object> additionalProperties) {
    ...
    private boolean equalTo(UpdateConnectionRequestContentAuth0 other) {
        return displayName.equals(other.displayName) && enabledClients.equals(other.enabledClients) && isDomainConnection.equals(other.isDomainConnection) && metadata.equals(other.metadata) && options.equals(other.options) && realms.equals(other.realms);
    }
