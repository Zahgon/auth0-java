...
public final class GetTokenExchangeProfileResponseContent {
    ...
    private GetTokenExchangeProfileResponseContent(Optional<String> id, Optional<String> name, Optional<String> subjectTokenType, Optional<String> actionId, Optional<TokenExchangeProfileTypeEnum> type, Optional<OffsetDateTime> createdAt, Optional<OffsetDateTime> updatedAt, Map<String, Object> additionalProperties) {
        this.id = id;
        this.name = name;
