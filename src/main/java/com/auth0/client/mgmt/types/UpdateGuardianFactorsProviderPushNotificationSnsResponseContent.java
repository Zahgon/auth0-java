...
public final class UpdateGuardianFactorsProviderPushNotificationSnsResponseContent {
    ...
    private UpdateGuardianFactorsProviderPushNotificationSnsResponseContent(OptionalNullable<String> awsAccessKeyId, OptionalNullable<String> awsSecretAccessKey, OptionalNullable<String> awsRegion, OptionalNullable<String> snsApnsPlatformApplicationArn, OptionalNullable<String> snsGcmPlatformApplicationArn, Map<String, Object> additionalProperties) {
