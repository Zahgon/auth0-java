...
public final class UpdateEmailProviderResponseContent {
    ...
    private UpdateEmailProviderResponseContent(Optional<String> name, Optional<Boolean> enabled, Optional<String> defaultFromAddress, Optional<EmailProviderCredentials> credentials, Optional<Map<String, Object>> settings, Map<String, Object> additionalProperties) {
        this.name = name;
