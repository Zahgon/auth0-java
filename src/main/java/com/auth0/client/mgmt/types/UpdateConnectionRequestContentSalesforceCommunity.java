...
public final class UpdateConnectionRequestContentSalesforceCommunity implements IConnectionCommon {
    ...
    private UpdateConnectionRequestContentSalesforceCommunity(Optional<String> displayName, Optional<List<String>> enabledClients, Optional<Boolean> isDomainConnection, Optional<Map<String, OptionalNullable<String>>> metadata, Optional<ConnectionOptionsSalesforceCommunity> options, Map<String, Object> additionalProperties) {
