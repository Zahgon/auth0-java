...
public final class GetOrganizationResponseContent {
    ...
    private GetOrganizationResponseContent(Optional<String> id, Optional<String> name, Optional<String> displayName, Optional<OrganizationBranding> branding, Optional<Map<String, OptionalNullable<String>>> metadata, Optional<TokenQuota> tokenQuota, Map<String, Object> additionalProperties) {
        this.id = id;
        this.name = name;
