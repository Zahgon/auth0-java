...
public final class CreateConnectionRequestContentYandex implements ICreateConnectionCommon {
    ...
    private CreateConnectionRequestContentYandex(String name, Optional<List<String>> enabledClients, Optional<String> displayName, Optional<Boolean> isDomainConnection, Optional<Map<String, OptionalNullable<String>>> metadata, CreateConnectionRequestContentYandexStrategy strategy, Optional<ConnectionOptionsYandex> options, Map<String, Object> additionalProperties) {
        this.name = name;
