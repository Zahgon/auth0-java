...
public final class ConnectionResponseContentSalesforceCommunity implements IConnectionPurposes, IConnectionResponseCommon, ICreateConnectionCommon {
    ...
    private ConnectionResponseContentSalesforceCommunity(Optional<ConnectionAuthenticationPurpose> authentication, Optional<ConnectionConnectedAccountsPurpose> connectedAccounts, String id, Optional<List<String>> realms, String name, Optional<List<String>> enabledClients, Optional<String> displayName, Optional<Boolean> isDomainConnection, Optional<Map<String, OptionalNullable<String>>> metadata, ConnectionResponseContentSalesforceCommunityStrategy strategy, Optional<ConnectionOptionsSalesforceCommunity> options, Map<String, Object> additionalProperties) {
