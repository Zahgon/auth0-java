...
public final class FormFieldUrl {
    ...
    private FormFieldUrl(String id, FormComponentCategoryFieldConst category, FormFieldTypeUrlConst type, Optional<FormFieldUrlConfig> config, Optional<String> label, Optional<String> hint, Optional<Boolean> required, Optional<Boolean> sensitive, Map<String, Object> additionalProperties) {
        this.id = id;
