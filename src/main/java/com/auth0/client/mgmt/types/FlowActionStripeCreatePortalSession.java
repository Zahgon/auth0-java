...
public final class FlowActionStripeCreatePortalSession {
    ...
    private FlowActionStripeCreatePortalSession(String id, Optional<String> alias, FlowActionStripeCreatePortalSessionType type, FlowActionStripeCreatePortalSessionAction action, Optional<Boolean> allowFailure, Optional<Boolean> maskOutput, FlowActionStripeCreatePortalSessionParams params, Map<String, Object> additionalProperties) {
        this.id = id;
        this.alias = alias;
        this.type = type;
        this.action = action;
