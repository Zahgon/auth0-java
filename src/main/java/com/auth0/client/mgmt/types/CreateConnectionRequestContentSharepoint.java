...
public final class CreateConnectionRequestContentSharepoint implements ICreateConnectionCommon {
    ...
    private CreateConnectionRequestContentSharepoint(String name, Optional<List<String>> enabledClients, Optional<String> displayName, Optional<Boolean> isDomainConnection, Optional<Map<String, OptionalNullable<String>>> metadata, CreateConnectionRequestContentSharepointStrategy strategy, Optional<ConnectionOptionsSharepoint> options, Optional<Boolean> showAsButton, Map<String, Object> additionalProperties) {
        this.name = name;
