...
public final class ConnectionResponseContentAzureAd implements IConnectionPurposes, IConnectionResponseCommon, ICreateConnectionCommon {
    ...
    private ConnectionResponseContentAzureAd(Optional<ConnectionAuthenticationPurpose> authentication, Optional<ConnectionConnectedAccountsPurpose> connectedAccounts, String id, Optional<List<String>> realms, String name, Optional<List<String>> enabledClients, Optional<String> displayName, Optional<Boolean> isDomainConnection, Optional<Map<String, OptionalNullable<String>>> metadata, ConnectionResponseContentAzureAdStrategy strategy, Optional<ConnectionOptionsAzureAd> options, Optional<String> provisioningTicketUrl, Optional<Boolean> showAsButton, Map<String, Object> additionalProperties) {
