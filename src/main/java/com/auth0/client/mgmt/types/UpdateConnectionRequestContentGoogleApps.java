...
public final class UpdateConnectionRequestContentGoogleApps implements IConnectionCommon {
    ...
    private UpdateConnectionRequestContentGoogleApps(Optional<String> displayName, Optional<List<String>> enabledClients, Optional<Boolean> isDomainConnection, Optional<Map<String, OptionalNullable<String>>> metadata, Optional<ConnectionOptionsGoogleApps> options, Optional<Boolean> showAsButton, Map<String, Object> additionalProperties) {
