...
public final class UpdateConnectionRequestContentAzureAd implements IConnectionCommon {
    ...
    private UpdateConnectionRequestContentAzureAd(Optional<String> displayName, Optional<List<String>> enabledClients, Optional<Boolean> isDomainConnection, Optional<Map<String, OptionalNullable<String>>> metadata, Optional<ConnectionOptionsAzureAd> options, Optional<Boolean> showAsButton, Map<String, Object> additionalProperties) {
