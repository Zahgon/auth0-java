...
public final class FormFieldDropdown {
    ...
    private FormFieldDropdown(String id, FormComponentCategoryFieldConst category, FormFieldTypeDropdownConst type, Optional<FormFieldDropdownConfig> config, Optional<String> label, Optional<String> hint, Optional<Boolean> required, Optional<Boolean> sensitive, Map<String, Object> additionalProperties) {
        this.id = id;
