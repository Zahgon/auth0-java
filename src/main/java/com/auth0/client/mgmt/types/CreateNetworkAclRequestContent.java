...
public final class CreateNetworkAclRequestContent {
    ...
    private CreateNetworkAclRequestContent(String description, boolean active, Optional<Double> priority, NetworkAclRule rule, Map<String, Object> additionalProperties) {
