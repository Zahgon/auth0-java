...
public final class UpdatePhoneTemplateResponseContent {
    ...
    private UpdatePhoneTemplateResponseContent(String id, Optional<String> channel, Optional<Boolean> customizable, Optional<String> tenant, PhoneTemplateContent content, PhoneTemplateNotificationTypeEnum type, boolean disabled, Map<String, Object> additionalProperties) {
        this.id = id;
