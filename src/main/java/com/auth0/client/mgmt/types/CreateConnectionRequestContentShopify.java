...
public final class CreateConnectionRequestContentShopify implements ICreateConnectionCommon {
    ...
    private CreateConnectionRequestContentShopify(String name, Optional<List<String>> enabledClients, Optional<String> displayName, Optional<Boolean> isDomainConnection, Optional<Map<String, OptionalNullable<String>>> metadata, CreateConnectionRequestContentShopifyStrategy strategy, Optional<ConnectionOptionsShopify> options, Map<String, Object> additionalProperties) {
        this.name = name;
