...
public final class CreateConnectionRequestContentVkontakte implements ICreateConnectionCommon {
    ...
    private CreateConnectionRequestContentVkontakte(String name, Optional<List<String>> enabledClients, Optional<String> displayName, Optional<Boolean> isDomainConnection, Optional<Map<String, OptionalNullable<String>>> metadata, CreateConnectionRequestContentVkontakteStrategy strategy, Optional<ConnectionOptionsVkontakte> options, Map<String, Object> additionalProperties) {
        this.name = name;
