...
public final class FormFieldSocial {
    ...
    private FormFieldSocial(String id, FormComponentCategoryFieldConst category, FormFieldTypeSocialConst type, Optional<FormFieldSocialConfig> config, Optional<String> label, Optional<String> hint, Optional<Boolean> required, Optional<Boolean> sensitive, Map<String, Object> additionalProperties) {
        this.id = id;
