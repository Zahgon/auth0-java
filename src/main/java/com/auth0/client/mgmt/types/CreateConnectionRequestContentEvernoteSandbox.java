...
public final class CreateConnectionRequestContentEvernoteSandbox implements ICreateConnectionCommon {
    ...
    private CreateConnectionRequestContentEvernoteSandbox(String name, Optional<List<String>> enabledClients, Optional<String> displayName, Optional<Boolean> isDomainConnection, Optional<Map<String, OptionalNullable<String>>> metadata, CreateConnectionRequestContentEvernoteSandboxStrategy strategy, Optional<ConnectionOptionsEvernote> options, Map<String, Object> additionalProperties) {
        this.name = name;
