...
public final class EncryptionKey {
    ...
    private EncryptionKey(String kid, EncryptionKeyType type, EncryptionKeyState state, OffsetDateTime createdAt, OffsetDateTime updatedAt, OptionalNullable<String> parentKid, OptionalNullable<String> publicKey, Map<String, Object> additionalProperties) {
        this.kid = kid;
        this.type = type;
        this.state = state;
