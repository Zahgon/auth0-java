...
public final class ListRolePermissionsRequestParameters {
    ...
    private ListRolePermissionsRequestParameters(OptionalNullable<Integer> perPage, OptionalNullable<Integer> page, OptionalNullable<Boolean> includeTotals, Map<String, Object> additionalProperties) {
