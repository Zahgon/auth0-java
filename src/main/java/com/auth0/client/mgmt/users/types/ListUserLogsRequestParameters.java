...
public final class ListUserLogsRequestParameters {
    ...
    private ListUserLogsRequestParameters(OptionalNullable<Integer> page, OptionalNullable<Integer> perPage, OptionalNullable<String> sort, OptionalNullable<Boolean> includeTotals, Map<String, Object> additionalProperties) {
        this.page = page;
    ...
    private boolean equalTo(ListUserLogsRequestParameters other) {
        return page.equals(other.page) && perPage.equals(other.perPage) && sort.equals(other.sort) && includeTotals.equals(other.includeTotals);
    }
