...
public final class ListUserPermissionsRequestParameters {
    ...
    private ListUserPermissionsRequestParameters(OptionalNullable<Integer> perPage, OptionalNullable<Integer> page, OptionalNullable<Boolean> includeTotals, Map<String, Object> additionalProperties) {
