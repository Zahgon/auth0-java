...
public final class ListUserRolesRequestParameters {
    ...
    private ListUserRolesRequestParameters(OptionalNullable<Integer> perPage, OptionalNullable<Integer> page, OptionalNullable<Boolean> includeTotals, Map<String, Object> additionalProperties) {
