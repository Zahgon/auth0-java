...
public final class ListUserOrganizationsRequestParameters {
    ...
    private ListUserOrganizationsRequestParameters(OptionalNullable<Integer> page, OptionalNullable<Integer> perPage, OptionalNullable<Boolean> includeTotals, Map<String, Object> additionalProperties) {
        this.page = page;
