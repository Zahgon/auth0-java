...
public final class ListUserAuthenticationMethodsRequestParameters {
    ...
    private ListUserAuthenticationMethodsRequestParameters(OptionalNullable<Integer> page, OptionalNullable<Integer> perPage, OptionalNullable<Boolean> includeTotals, Map<String, Object> additionalProperties) {
        this.page = page;
