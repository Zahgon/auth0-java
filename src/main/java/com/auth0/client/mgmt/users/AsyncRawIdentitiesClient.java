...
public class AsyncRawIdentitiesClient {
     ...
     * </ul></p>
     */
    public CompletableFuture<ManagementApiHttpResponse<List<UserIdentity>>> link(String id, RequestOptions requestOptions) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     * </ul></p>
     */
    public CompletableFuture<ManagementApiHttpResponse<List<UserIdentity>>> link(String id, LinkUserIdentityRequestContent request) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     * </ul></p>
     */
    public CompletableFuture<ManagementApiHttpResponse<List<UserIdentity>>> link(String id, LinkUserIdentityRequestContent request, RequestOptions requestOptions) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     */
    public CompletableFuture<ManagementApiHttpResponse<List<DeleteUserIdentityResponseContentItem>>> delete(String id, UserIdentityProviderEnum provider, String userId) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     * <p>Unlinking the secondary account removes it from the identities array of the target user and creates a new standalone profile for the secondary account. To learn more, review <a href="https://auth0.com/docs/manage-users/user-accounts/user-account-linking/unlink-user-accounts">Unlink User Accounts</a>.</p>
     */
    public CompletableFuture<ManagementApiHttpResponse<List<DeleteUserIdentityResponseContentItem>>> delete(String id, UserIdentityProviderEnum provider, String userId, RequestOptions requestOptions) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
}
