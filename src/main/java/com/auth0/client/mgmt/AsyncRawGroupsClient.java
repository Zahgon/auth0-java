...
public class AsyncRawGroupsClient {
     ...
     * List all groups in your tenant.
     */
    public CompletableFuture<ManagementApiHttpResponse<SyncPagingIterable<Group>>> list(ListGroupsRequestParameters request) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     * List all groups in your tenant.
     */
    public CompletableFuture<ManagementApiHttpResponse<SyncPagingIterable<Group>>> list(ListGroupsRequestParameters request, RequestOptions requestOptions) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     * Retrieve a group by its ID.
     */
    public CompletableFuture<ManagementApiHttpResponse<GetGroupResponseContent>> get(String id, RequestOptions requestOptions) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
