...
public class AsyncRawTicketsClient {
     ...
     */
    public CompletableFuture<ManagementApiHttpResponse<VerifyEmailTicketResponseContent>> verifyEmail(VerifyEmailTicketRequestContent request) {
     ...
     * Create an email verification ticket for a given user. An email verification ticket is a generated URL that the user can consume to verify their email address.
     */
    public CompletableFuture<ManagementApiHttpResponse<VerifyEmailTicketResponseContent>> verifyEmail(VerifyEmailTicketRequestContent request, RequestOptions requestOptions) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     * <p>Note: This endpoint does not verify the given user’s identity. If you call this endpoint within your application, you must design your application to verify the user’s identity.</p>
     */
    public CompletableFuture<ManagementApiHttpResponse<ChangePasswordTicketResponseContent>> changePassword(RequestOptions requestOptions) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     * <p>Note: This endpoint does not verify the given user’s identity. If you call this endpoint within your application, you must design your application to verify the user’s identity.</p>
     */
    public CompletableFuture<ManagementApiHttpResponse<ChangePasswordTicketResponseContent>> changePassword(ChangePasswordTicketRequestContent request) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     * <p>Note: This endpoint does not verify the given user’s identity. If you call this endpoint within your application, you must design your application to verify the user’s identity.</p>
     */
    public CompletableFuture<ManagementApiHttpResponse<ChangePasswordTicketResponseContent>> changePassword(ChangePasswordTicketRequestContent request, RequestOptions requestOptions) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
}
