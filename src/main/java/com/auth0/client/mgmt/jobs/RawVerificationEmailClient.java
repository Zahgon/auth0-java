...
public class RawVerificationEmailClient {
     ...
     */
    public ManagementApiHttpResponse<CreateVerificationEmailResponseContent> create(CreateVerificationEmailRequestContent request) {
     ...
     * <p>Note: You must have the <code>Status</code> toggle enabled for the verification email template for the email to be sent.</p>
     */
    public ManagementApiHttpResponse<CreateVerificationEmailResponseContent> create(CreateVerificationEmailRequestContent request, RequestOptions requestOptions) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
}
