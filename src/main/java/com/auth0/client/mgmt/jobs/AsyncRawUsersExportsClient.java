...
public class AsyncRawUsersExportsClient {
     ...
     * Export all users to a file via a long-running job.
     */
    public CompletableFuture<ManagementApiHttpResponse<CreateExportUsersResponseContent>> create(RequestOptions requestOptions) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     * Export all users to a file via a long-running job.
     */
    public CompletableFuture<ManagementApiHttpResponse<CreateExportUsersResponseContent>> create(CreateExportUsersRequestContent request) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     * Export all users to a file via a long-running job.
     */
    public CompletableFuture<ManagementApiHttpResponse<CreateExportUsersResponseContent>> create(CreateExportUsersRequestContent request, RequestOptions requestOptions) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
}
