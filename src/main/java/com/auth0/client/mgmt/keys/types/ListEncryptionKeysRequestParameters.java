...
public final class ListEncryptionKeysRequestParameters {
    ...
    private ListEncryptionKeysRequestParameters(OptionalNullable<Integer> page, OptionalNullable<Integer> perPage, OptionalNullable<Boolean> includeTotals, Map<String, Object> additionalProperties) {
        this.page = page;
