...
public class AsyncRawCustomSigningClient {
     ...
     * Get entire jwks representation of custom signing keys.
     */
    public CompletableFuture<ManagementApiHttpResponse<GetCustomSigningKeysResponseContent>> get(RequestOptions requestOptions) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     */
    public CompletableFuture<ManagementApiHttpResponse<SetCustomSigningKeysResponseContent>> set(SetCustomSigningKeysRequestContent request) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     * Create or replace entire jwks representation of custom signing keys.
     */
    public CompletableFuture<ManagementApiHttpResponse<SetCustomSigningKeysResponseContent>> set(SetCustomSigningKeysRequestContent request, RequestOptions requestOptions) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
