...
public final class ListVerifiableCredentialTemplatesRequestParameters {
    ...
    private ListVerifiableCredentialTemplatesRequestParameters(OptionalNullable<String> from, OptionalNullable<Integer> take, Map<String, Object> additionalProperties) {
        this.from = from;
        this.take = take;
